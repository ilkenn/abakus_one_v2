...
/// Core courier/delivery/shift/device/event repositories, id-generators,
/// and services — Phase 5's original dependency set, before Sprints
/// 5A-5D each added their own sub-domain (now split into sibling
/// `courier_*_dependencies_provider.dart` files, Sprint 5E Part 7,
/// `docs/decisions.md` ADR-022). All in-memory today, no real-time
/// backend exists yet (`docs/decisions.md` ADR-017). Deliberately
/// **not** importing anything from `pos/presentation/providers/*` —
/// courier and KDS dependency graphs stay parallel, never sharing a
/// provider file.
