...
class AllowAllAllergensPolicy implements PosAuthorizationPolicy {
  const AllowAllAllergensPolicy();
...
class DenyAllAllergensPolicy implements PosAuthorizationPolicy {
  const DenyAllAllergensPolicy();
