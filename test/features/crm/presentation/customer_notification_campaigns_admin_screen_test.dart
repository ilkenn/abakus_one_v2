...
import 'package:abakus_one_v2/features/crm/presentation/screens/customer_notification_campaigns_admin_screen.dart';
...
void main() {
  testWidgets('shows an empty state with no campaigns yet', (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: MaterialApp(
          home: CustomerNotificationCampaignsAdminScreen(
    ...
    expect(find.text('Henüz kampanya oluşturulmadı.'), findsOneWidget);
  });
}
