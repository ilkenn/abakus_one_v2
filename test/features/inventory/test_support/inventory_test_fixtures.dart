...
class AllowAllInventoryPolicy implements PosAuthorizationPolicy {
  const AllowAllInventoryPolicy();
...
class DenyAllInventoryPolicy implements PosAuthorizationPolicy {
  const DenyAllInventoryPolicy();
