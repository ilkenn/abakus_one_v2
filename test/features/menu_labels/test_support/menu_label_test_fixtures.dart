...
class AllowAllMenuLabelsPolicy implements PosAuthorizationPolicy {
  const AllowAllMenuLabelsPolicy();
...
class DenyAllMenuLabelsPolicy implements PosAuthorizationPolicy {
  const DenyAllMenuLabelsPolicy();
