...
class AllowAllNutritionPolicy implements PosAuthorizationPolicy {
  const AllowAllNutritionPolicy();
...
class DenyAllNutritionPolicy implements PosAuthorizationPolicy {
  const DenyAllNutritionPolicy();
