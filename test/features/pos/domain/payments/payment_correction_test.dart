...
void main() {
  group('PaymentCorrection — paymentMethodCorrection', () {
    test('links the original split to its replacement with before/after method snapshots', () {
      final correction = PaymentCorrection(
        ...
        previousPaymentMethodSnapshot: PaymentMethodSnapshot.capture(PaymentMethodSeedData.cash),
        newPaymentMethodSnapshot: PaymentMethodSnapshot.capture(PaymentMethodSeedData.creditCard),
      ...
      expect(correction.newPaymentMethodSnapshot!.paymentMethodId, 'credit_card');
    });
