...
class AllowAllPurchasingPolicy implements PosAuthorizationPolicy {
  const AllowAllPurchasingPolicy();
...
class DenyAllPurchasingPolicy implements PosAuthorizationPolicy {
  const DenyAllPurchasingPolicy();
