...
class AllowAllSetupPolicy implements PosAuthorizationPolicy {
  const AllowAllSetupPolicy();
...
class DenyAllSetupPolicy implements PosAuthorizationPolicy {
  const DenyAllSetupPolicy();
